      ...
      <section class="side-bar-container" >
        ...
        <section class="side-bar">
            ...
            <el-menu
              ...
              <el-submenu :index="item.Category.Id+'-'+index" v-for="(item,index) in cateGoryList" :key="item.Category.Id" >
                ...
                <!-- <el-submenu :index="citem.Id+'-'+cindex" v-for="(citem,cindex) in item.Children" :key="item.Category.Id + '-' + cindex">
                  <template slot="title">{{citem.Title}}</template>
                  <el-menu-item v-for="(nitem,nindex) in citem.Children" :index="nitem.Id + '-' + nindex" :key="nitem.Id">{{nitem.Title}}</el-menu-item>
                </el-submenu> -->
        ...
        <section class="content">
            <div class="product-con">
              <p class="sum-text">为您找到“{{keyword}}”相关的<span class="sum-color">{{' '+ dataRecord+' ' }}</span>条结果</p>
            </div>
            <section class="build-standard" style="padding-top:0.35rem">
              <div class="books-list ">
                ...
                <div class="zaiti pro-types">
                  <!-- <span>载体</span> -->
                  <!-- <img src="../assets/images/search/下拉三角.png"> -->

                  <el-dropdown trigger="click" @command="handleCommandType" style="margin-right:0.8rem">
                      ...
                      <el-dropdown-menu slot="dropdown" >
                        ...
                        <el-dropdown-item divided :command="104">图书</el-dropdown-item>
                        <el-dropdown-item divided :command="102">章节</el-dropdown-item>
                        <el-dropdown-item divided :command="109">视频</el-dropdown-item>
                        <el-dropdown-item divided :command="107">课程</el-dropdown-item>
                        <el-dropdown-item divided :command="108">图谱</el-dropdown-item>
                      </el-dropdown-menu>
                    </el-dropdown>
                </div>
...
export default {
  ...
  methods:{
    ...
    getDataByKeyword(cp = 1,isLoadMore = false) {
      ...
      let typeArr = [];
      if(this.objectType !== '') {
        typeArr = [this.objectType]
      }else {
        typeArr = [102,104,108,109,107]
      }
